                  ...
                  <v-list-item-title class="align-center">
                    <div>
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field label="Enter username" v-model="username"></v-text-field>
                      </v-col>
                    </div>
      ...
      <v-footer height="auto" color="indigo" dark>
        <v-layout justify-center row wrap>
          ...
          >
            <strong>
              Developed with ❤️ by
              <a target="_blank" href="https://twitter.com/stevensunflash">
                <span class="style-name">@stevensunflash</span>
              </a>
...
export default {
  ...
  methods: {
    checkUsername() {
      this.loading = true;
      axios
        .post(`${API_ROUTE}/username`, this.checkUrl)
        .then(res => {
